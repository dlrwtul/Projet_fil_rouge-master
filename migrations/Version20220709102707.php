 ...
 */
final class Version20220709102707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande_produit ADD burger_id INT DEFAULT NULL, ADD boisson_taille_id INT DEFAULT NULL, ADD portion_frites_id INT DEFAULT NULL, ADD menu_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande_boisson_taille (id INT NOT NULL, boisson_taille_id INT DEFAULT NULL, INDEX IDX_CB21213B75B6EEA7 (boisson_taille_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE commande_burger (id INT NOT NULL, burger_id INT DEFAULT NULL, INDEX IDX_EDB7A1D817CE5090 (burger_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE commande_menu (id INT NOT NULL, menu_id INT DEFAULT NULL, INDEX IDX_16693B70CCD7E912 (menu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE commande_portion_frites (id INT NOT NULL, portion_frites_id INT DEFAULT NULL, INDEX IDX_76BD26B8203D026B (portion_frites_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE commande_produit DROP burger_id, DROP boisson_taille_id, DROP portion_frites_id, DROP menu_id');
    }
}
